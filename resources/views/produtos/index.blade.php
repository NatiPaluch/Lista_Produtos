...
@section('content')
    ...
    <table class="table table-striped">
        <thead><tr><th>ID</th><th>Nome</th><th>Preço</th><th>Categoria</th><th>Editar</th></tr></thead>
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('produtos.edit', $produto) }}" class="btn btn-primary btn-sm">Editar <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
